...
from UnitTest_Demo.TestCase_Demo import Test_Case_Class
from UnitTest_Demo.TestCase_3 import Test_Case_Class_3
from UnitTest_Demo.TestCase_Demo_2 import Test_Case_Demo_2


#Get all the tests from Test_Case_Class_3 & Test_Case_Class classes. Create objs TstClass1 & 2. using TestLoader
#variable objects
TstClass1 = unittest.TestLoader().loadTestsFromTestCase(Test_Case_Class)
TstClass2 = unittest.TestLoader().loadTestsFromTestCase(Test_Case_Class_3)
